...
async fn main() -> Result<()> {
    ...
    match cli.command {
        Some(Commands::MemoryTest { number, per_number }) => {
        ...
        Some(Commands::FailTest { number,per_number }) => {
        ...
        Some(Commands::ConfigGen {
            ...
            let distribution_plan = DistributionPlan::new(number, per_number, hosts, config, failure_nodes);
